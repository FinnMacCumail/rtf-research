...
### Added
- **Phase 5 continuation: stratified 90-question benchmark (v5) & the ceiling result - Sep 2026**: Scaled the evaluation dataset from 6 to 90 questions to test the premise behind model-handoff routing — that query difficulty predicts which model should handle a query ([ollamaDeepAgents](https://github.com/FinnMacCumail/ollamaDeepAgents))
